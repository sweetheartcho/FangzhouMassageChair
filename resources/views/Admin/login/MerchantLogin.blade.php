...
<div class="login">
    <div class="login-top">
        ...
        <form id="login_form" method="post" action="">
            {{ csrf_field() }}
            <input name="Merchant[account]" type="text" placeholder="用户帐号" id="input-name">
            <input name="Merchant[password]" type="password" placeholder="密码" id="input-pwd">
            <div class="forgot">
...
<script>
    ...
    $(function () {
        ...
        $("#submit-button").click(function(){
            ...
            $.ajax({
                type: 'post',
                url: "{{ url('Admin/Login/MerchantLogin') }}",
                data: {Merchant: {account: name, password: pwd}},
