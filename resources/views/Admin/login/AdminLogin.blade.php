...
<div class="login">
    <div class="login-top">
        ...
        <form id="login_form" method="post" action="">
            {{ csrf_field() }}
            <input name="User[account]" type="text" placeholder="用户帐号" id="input-name">
            <input name="User[password]" type="password" placeholder="密码" id="input-pwd">
            <div class="forgot">
    ...
    $(function () {
        ...
        $("#submit-button").click(function(){
            ...
            $.ajax({
                ...
                data: {User: {account: name, password: pwd}},
